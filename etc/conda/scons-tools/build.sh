...
cp ${RECIPE_DIR}/activate.sh ${PREFIX}/etc/conda/activate.d/scons-tools_vars.sh

mkdir -p ${PREFIX}/etc/conda/deactivate.d
cp ${RECIPE_DIR}/deactivate.sh ${PREFIX}/etc/conda/deactivate.d/scons-tools_vars.sh
